...
_DESCRIPTION = """\
 ...
 contains total 1867 segmented images, which 1219 malignant cells images are
 labeled as class 1, 648 normal cells images are labeled as class 0. The size
 of each image is 450 x 450 pixels x 3."""


class BALL(tfds.core.GeneratorBasedBuilder):
